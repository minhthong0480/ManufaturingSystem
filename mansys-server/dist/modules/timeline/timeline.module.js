...
let TimelineModule = exports.TimelineModule = class TimelineModule {
};
exports.TimelineModule = TimelineModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([timeline_entity_1.Timeline])],
        controllers: [timeline_controller_1.TimelinesController],
        providers: [timeline_service_1.TimelinesService]
    })
], TimelineModule);

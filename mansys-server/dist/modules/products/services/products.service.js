...
let ProductsService = exports.ProductsService = class ProductsService {
    ...
    getProductById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const product = yield this.productsRepository.findBy({ id });
            if (product) {
                return result_model_1.ResultModel.success(product, 'Get product successful');
            }
            return result_model_1.ResultModel.fail('', 'Product not exist!');
        });
    }
    getOneById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.productsRepository.findOneBy({ id });
        });
    }
};

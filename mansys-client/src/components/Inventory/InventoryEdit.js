    ...
    <Fragment>
      <div className="main-content-container">
        <h1 className="m-top--1rem">
          {disabled ? "Chi tiết Inventory" : "Chỉnh sửa Inventory"}
        </h1>
        ...
        <Row gutter={16} className="m-top--1rem">
          ...
          <Col span={4}>
            ...
            <Input
              ...
              onChange={(e) => handleInforChange("lastUpdate", e.target.value)}
              type="date"
              placeholder="lastUpdate"
            />
            {deliverNoteError.lastUpdate && (
              <span className="error">{deliverNoteError.lastUpdate}</span>
            )}
          </Col>
        </Row>
        <Row gutter={16} className="m-top--1rem">

...
import { API_CONTRACT, API_CONTRACT_FILTER, API_CONTRACT_CREATE, API_CONTRACT_STATUS } from '../commons/enum'
...
export const ContractService = {
	...
	get: async function (id) {
		...
		if (result.status >= 400 || !result.data.isSuccess) return requestFail(result.data.message)
